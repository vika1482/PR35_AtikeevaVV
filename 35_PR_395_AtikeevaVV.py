...
def calculate():
    ...
    try:
        ...
        messagebox.showinfo('Внимание', 'Значение введено неверно!')
        calc.insert(0, 0)
...
def make_plus_minus_button():
    return tk.Button(text=pt, bd=5, font=('Arial',13),command=lambda: plus_minus())

#запрет на буквы c клавиатуры
def press_key(event):
    print (event.char)
